...
export const HELP_REGISTRY: HelpEntry[] = [
  ...
  { surface: "overview", title: "Venue Overview", bullets: ["Orientation surface — what is the current venue state?", "Shows execution pulse, recent progress, and recommended next move", "Use quick actions to jump to assessment, diagnosis, or plan", "The operating picture updates after each engine run"] },
  { surface: "assessment", title: "Assessment", bullets: ["Paste operational observations for AI signal detection", "The intake quality bar shows when you have enough detail", "Review and confirm each detected signal before saving", "After saving, run the engine to generate the diagnosis"] },
  ...
  { surface: "diagnosis", title: "Diagnosis", bullets: ["Shows failure modes, response patterns, and the diagnostic spine", "Use compare to see changes from prior runs", "Export as markdown or JSON for external sharing", "The trust surface shows diagnostic confidence levels"] },
  { surface: "history", title: "History", bullets: ["Every analyzed venue state becomes a reviewable record", "Click an entry to load its snapshot and compare with current", "Signal count trends show operational improvement trajectory", "Ontology identity is preserved per historical entry"] },
